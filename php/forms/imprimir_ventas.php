...
$ID_VALOR = "PAR_ID"; ?>
<form action="php/reports/reporte_ventas.php" method="post" enctype="multipart/form-data">
...
Imprimir de fecha: <input type="text" id="PAR_FECHA_VE" name="PAR_FECHA_VE" value=""/>

a fecha: <input type="text" id="PAR_FECHA_VE2" name="PAR_FECHA_VE2" value=""/>
